...
public class ImageResults {
    ...
    /*
     * This function sits at the core of the technique: find Regions (aka 'blobs') of lit pixels - where lit is determined
     * by thresholding after color match.
	...
	int nregions = 0;
	for (int i = 0; i < Math.min(3, this.regions.size()) &&       // Only 3 hoops in view in 2013
