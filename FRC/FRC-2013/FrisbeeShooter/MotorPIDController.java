...
public class MotorPIDController {
    private class MotorPIDSource implements PIDSource {
        final ArduinoRPMSensor rpmSensor;
        final byte rpmSensorNum;
        final String logHdr;
        double rpm;

        MotorPIDSource(final String logPrefix,
...
//                System.out.println(logHdr + "=" + rpm);
    ...
    private class MotorPIDOutput implements PIDOutput {
        final String logHdr;
        final Victor motor;
        double currValue = 0.0;

        MotorPIDOutput(final String logPrefix, final Victor _motor) {
...
//            System.out.println(logHdr + "=" + newVal + ", Change=" + output);
    ...
    private final MotorPIDSource rpmSrc;
    private final MotorPIDOutput motorCtl;
    private final PIDController pidCtl;
    private final double rpmTolerance;

    public MotorPIDController(String logPrefix,
        ...
        motor = _motor;
        rpmSrc = new MotorPIDSource(logPrefix, sensor, rpmSensorNum);
        motorCtl = new MotorPIDOutput(logPrefix, motor);
