...
public class Corner extends Thread {
	...
	if (intersection == null) {
	    ...
	    if ((verticalError > maxError * length(verticalLine)) || 
		(horizontalError > maxError * length(horizontalLine)))
    ...
    static double length(Line2D.Double line) {
    ...
    static public Point2D.Double intersectingPoint(Line2D.Double line1, Line2D.Double line2) {
