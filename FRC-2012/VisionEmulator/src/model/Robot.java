...
public class Robot extends Observable {
    ...
    private static final int MAX_X_OFFSET = 57 * 12;

    // The fender limits how close we can get
    private static final int MIN_X_OFFSET = 39;

    // The field width is half of 27'
    private static final int MAX_Y_OFFSET = 27 * 12 / 2;
    private static final int MIN_Y_OFFSET = -27 * 12 / 2;
    ...
    // yOffset = 36 would be 3 feet to the right of the basket
    //
    ...
    //   basket would be to the left of the robot (assuming yOffset = 0)
    private int xOffset;
    private int yOffset;
