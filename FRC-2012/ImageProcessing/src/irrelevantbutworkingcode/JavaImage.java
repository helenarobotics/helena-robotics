...
//                long startTime = System.currentTimeMillis();
		...
		ImageIO.write(iout, "jpg", new File("SumLU_" + fileNum + ".jpg"));


		// threshold and write again:

		BufferedImage thresholded = thresholdImage(iout, 50);
		ImageIO.write(thresholded, "jpg", new File("Threshold_" + fileNum + ".jpg"));


		// Look for corners

		Kernel cornerKernel = new Kernel(5, 5, new float[] {
			-0.2f, -0.2f, -0.2f, -0.2f, -0.2f,
			-0.2f, 0.2f, 0.2f, 0.20f, 0.2f,
