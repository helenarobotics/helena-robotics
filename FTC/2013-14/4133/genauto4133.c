...
#pragma config(Sensor, S2,     s2,             sensorNone)
...
#pragma config(Servo,  srvo_S1_C2_1,    IR,                   tServoStandard)
...
#include "drivers/hitechnic-gyro.h"  //Include file for the gyro sensor utilities
...
const int nMoves = 6; //Defines how many Move+Turns to take during autonomous
...
string gRun [4]   = {gcBeaconBlock, gcPlaceBlock, gcDefense, gcCDefense};
int    gRunIdx  = 0;
string gSide [2]   = {gcLeft, gcRight};
int    gSideIdx  = 0;
int    gPos     = 1;
int    gPath    = 1;
...
//                                       place ring
//
// Place autonomous block while sensing the IR beacon
//
/////////////////////////////////////////////////////////////////////////////////////////////////
...
///
//////////////////////////////////////////////////////////////////////////////////////////////////
void defense (string iSide, int iPos, int iBeacon)
{
...
//
/////////////////////////////////////////////////////////////////////////////////////////////////////
void cdefense (string iSide, int iPos)
{
