...
#pragma config(Motor,  motorA,          spinner,       tmotorNormal, PIDControl, encoder)
...
#pragma config(Servo,  srvo_S1_C2_2,    middleScoop,          tServoStandard)
...
void scoopControl()
{
  ...
  {
    servo[leftScoop] = 46;
    servo[middleScoop] = 46;
    servo[rightScoop] = 46;
  }
  if (joy2Btn(4))
  {
    servo[leftScoop] = 175;
    servo[middleScoop] = 175;
    servo[rightScoop] = 175;
  }
  if (joy2Btn(6))
  {
    servo[leftScoop] = 195;
    servo[middleScoop] = 195;
