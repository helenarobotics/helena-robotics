...
// until we generalize this file
#define ROBOT_NAME ROBOT_NAME_FTC417_2010_V12
...
//            PackDispenserArmFromEOPD(disp, cm);
    ...
    if (fButton3) {
        // just pack, dang it, from wherever we are
...
//        DispenseFromEOPDPosition(disp, cm);
        ...
        case svposRotorStop:
            svposRotorRotorSpeed = svposRotorSlow;
            cBeep = 1;
            break;

        case svposRotorSlow:
            svposRotorRotorSpeed = svposRotorFast;
            cBeep = 2;
            break;
        case svposRotorFast:
            svposRotorRotorSpeed = svposRotorStop;
            cBeep = 3;
            break;
        }
