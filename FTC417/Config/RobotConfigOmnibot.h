...
//
// Static configuration information about the robot: its geometry, sensors, etc.
// Note that edits to this file invariably need to remain in sync with changes
// to the boilerplate at the start of .c files.
...
void InitializeMotors(IN OUT STICKYFAILURE& fOverallSuccess)
    ...
    InitializeMotor(fOverallSuccess, motorLeftFront,  motorControllerLeft, 1,  "motorLeftFront", MOTORPROP_ENCODER);
    InitializeMotor(fOverallSuccess, motorLeftBack ,  motorControllerLeft, 2,  "motorLeftBack", MOTORPROP_ENCODER);
    InitializeMotor(fOverallSuccess, motorRightFront, motorControllerRight, 1, "motorRightFront", MOTORPROP_ENCODER);
    InitializeMotor(fOverallSuccess, motorRightBack,  motorControllerRight, 2, "motorRightBack", MOTORPROP_ENCODER);
    }
