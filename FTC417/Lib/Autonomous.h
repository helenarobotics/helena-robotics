...
DoAutonomous() {
    ...
    if (fGoForMiddleDispenser) {
        ...
        RET_IF_FAIL(DriveForwardsAndStraightenUsingRightSonic(-(72 +
                    33) * sideReflection + cmExtra, DRIVE_POWER_FAST),
            "straighten");
...
// Implement our autonomous strategy
{
    ...
    if (!fRobotInTheWay) {
        ...
        RET_IF_FAIL(DriveForwardsAndStraightenUsingLeftSonic(72,
                DRIVE_POWER_FAST), "AfterCliff");
