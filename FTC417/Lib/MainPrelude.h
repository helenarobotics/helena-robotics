...
// A STICKYFAILURE is a boolean that is initially true but once set to false is to
// remain so. This is useful, for example, for carring out a long initialization
// sequence (that might call many functions) and testing the overall success at the end.
