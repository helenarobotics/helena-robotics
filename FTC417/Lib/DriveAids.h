...
BOOL
DriveForwardsAndStraightenUsingRightSonic(float cmDistance, int powerLevel) {
...
BOOL
AdjustLaterallyUsingAngle(float dcm, ANGLE degAngle) {
    ...
    RET_IF_FAIL(TurnRight(-degAngle, TURN_POWER_FAST,
            TURN_BALANCE_ADJUSTLATERAL), "TurnRight");
    RET_IF_FAIL(DriveForwards(hypotenuse, DRIVE_POWER_SLOW), "DriveForwards");
    RET_IF_FAIL(TurnRight(degAngle, TURN_POWER_FAST,
            TURN_BALANCE_ADJUSTLATERAL), "TurnBack");
