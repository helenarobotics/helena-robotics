...
task main()
{
  ...
  while(true)
  {
    ...
    if(ServoValue[servo5] < 72)              // If servo1 is closer to 0 (than 145):
    {
      while(ServoValue[servo5] < 145)               // While the ServoValue of servo1 is less than 145:
      {
        servo[servo5] = 145;                              // Move servo1 to position to 145.
      }
    }

    wait1Msec(1000);                          // Wait 1 second.

    if(ServoValue[servo5] >= 73)             // If servo1 is closer to 145 (than 0):
    {
    ...
    if(ServoValue[servo4] < 72)              // If servo1 is closer to 0 (than 145):
    {
      while(ServoValue[servo4] < 145)               // While the ServoValue of servo1 is less than 145:
      {
        servo[servo4] = 145;                              // Move servo1 to position to 145.
      }
    }

    wait1Msec(1000);                          // Wait 1 second.

    if(ServoValue[servo4] >= 73)             // If servo1 is closer to 145 (than 0):
    {
