...
#pragma config(Motor,  mtr_S1_C2_1,     DriveRight,    tmotorNormal, openLoop, reversed, encoder)
#pragma config(Motor,  mtr_S1_C2_2,     DriveLeft,     tmotorNormal, openLoop, encoder)
